...
@interface EzSampleObjectCustomPropertiesWithIVarSynchronizedForEachWithSleep : NSObject <EzSampleObjectProtocol>
{
	...
	__strong NSObject* _lockForAtomic;
	__strong NSObject* _lockForAtomicReadAndNonAtomicWrite;
}
