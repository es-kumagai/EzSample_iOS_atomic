...
@interface EzSampleObjectCustomPropertiesWithIVarSemaphoreForEachWithoutSleep : NSObject <EzSampleObjectProtocol>
{
	...
	dispatch_semaphore_t _semaphoreForAtomic;
	dispatch_semaphore_t _semaphoreForAtomicReadAndNonAtomicWrite;
}
