...
@interface EzSampleObjectCustomPropertiesWithIVarNSLockForEachWithSleep : NSObject <EzSampleObjectProtocol>
{
	...
	__strong NSLock* _lockForAtomic;
	__strong NSLock* _lockForAtomicReadAndNonAtomicWrite;
}
